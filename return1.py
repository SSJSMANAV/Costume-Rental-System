...
def logical_quantity(ID):
    ...
    if 0 < quantity_1:
        ...
        brand1.append(brand)
        print("")
        ask = input("Do you want to return more costume? (yes/no)").lower()
        print("")
        if ask == "yes":
            returning_costume()
        else:
...
def invoice():
    ...
    print("Number Of customer: ",phone)
    print("Date of return: ",a)
    print("-"*58)
    ...
    billinvoice.append(return_bill)
    billinvoice.append("\nCustomer Name: "+name)
    billinvoice.append("Customer Phone: "+phone)
    billinvoice.append("Date Of Return: "+a+"\n")
